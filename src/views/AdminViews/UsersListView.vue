...
<template>
  ...
  <div class="min-h-screen bg-gradient-to-b from-gray-100 to-white p-6 mt-3">
    ...
    <transition name="fade-modal">
      ...
      >
        <div
          class="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl w-full max-w-sm sm:max-w-lg shadow-xl transition-all duration-300 transform scale-95 hover:scale-100"
        >
          ...
          <form @submit.prevent="submitCreateUser">
            ...
            <div class="flex justify-end space-x-2 mt-4">
              <button
                ...
                class="px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-white rounded-md"
              >
                Cancelar
              </button>
              <button
    ...
    <!-- Si no hay usuarios -->
    <div v-else class="text-center text-gray-600 dark:text-gray-400">No users found.</div>

    <!-- Si hay error -->
    <div v-if="error" class="text-center text-red-500 mt-6">Failed to load users.</div>
    ...
    <transition name="fade-modal">
      ...
      >
        <div
          class="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-xl shadow-xl w-full max-w-sm sm:max-w-md transform transition-all duration-300 scale-95 hover:scale-100"
        >
