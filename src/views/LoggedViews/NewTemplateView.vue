...
import { newTemplate } from '../../composable/NewTemplate'
...
<template>
  <div
    class="min-h-screen bg-gradient-to-br from-blue-100 to-purple-200 flex items-center justify-center"
  >
          ...
          <div v-else-if="step === 5">
            ...
            <div class="mb-4">
              ...
              <ul class="list-disc list-inside ml-4">
                <li
                  v-for="header in form.selected_headers.filter((h) => h.active)"
                  :key="header.name"
                >
                  {{ header.name }}
                </li>
