...
<template>
  <div class="flex h-auto">
    ...
    >
      ...
      <RouterLink to="/catalogs" @click="closeNav" class="rounded-b-2xl transition duration-500 ease-in-out text-white text-center p-4 pb-5 text-xl hover:bg-slate-900" active-class="bg-slate-800">{{ $t('dashboard_view_catalog_title') }}</RouterLink>
      <RouterLink to="/templates" v-if="role && role === 'admin'" @click="closeNav" class="rounded-b-2xl transition duration-500 ease-in-out text-white text-center p-4 pb-5 text-xl hover:bg-slate-900" active-class="bg-slate-800">{{ $t('dashboard_template_ops_title') }}</RouterLink>
